...
# nodls
/ˈnoːd(ə)lz/ by [No Despondency Labs](https://www.linkedin.com/company/nodls)
...
| Relationship operations | Insert/delete relationship elements with dedicated syntax (for example source.relationship) | No equivalent relationship object syntax; insert/update foreign key column values instead |
...
| Delete semantics | `DELETE` dataset items by predicate; relationship element delete syntax available | `DELETE` rows by predicate; no native relationship-delete syntax |
